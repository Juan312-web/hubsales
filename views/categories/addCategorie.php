    ...
    <form method="POST" id="categorie__add" class="form">
      ...
      <div class="form__row">
        ...
        <div class="form__row__item">
          ...
          <input require autocomplete="name" name="cat_name" id="cat_name" type="text" class="form__input" placeholder="cafe" value="<?php echo $data->cat_name ?>">
        </div>
      </div>
      <div class="form__row">
        <!-- * ------------------------------ * -->
        <div class="form__row__item">
          ...
          <textarea require name="cat_description" id="cat_description" class="form__input" maxlength="100" value="<?php echo $data->cat_description ?>"></textarea>
        </div>
      </div>
